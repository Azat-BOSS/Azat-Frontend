    ...
    <AnimatePresence>
      ...
      viewport={{once: true}}>
        ...
        <div className={introStyle.intro__text__container}>
          ...
          <motion.button onClick={() => dispatch(changeState(true))} custom={3} whileHover={{scale: 1.05}} variants={elementsView} className={introStyle.intro__button}>Contact me</motion.button>
        </div>
      </motion.div>
    </AnimatePresence>
  );
